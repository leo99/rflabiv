...
\begin{figure}[!h]
\begin{center}
	\epsfig{file=inSmith.eps, width=\textwidth}
	\setlength{\unitlength}{1mm}
		\setlength{\fboxsep}{1mm}
	\begin{picture}(1,1)
		\linethickness{0.5mm}
		{\color{dkgrn}
		\put(-40, 150){\fcolorbox{dkgrn}{white}{$\rho_\mathrm{S} = 0.499 \,\angle {+112.6 {\,}^\circ}$}}
		\put(-40, 60){\fcolorbox{dkgrn}{white}{$\rho_\mathrm{S}^* = 0.499 \,\angle {-112.6 {\,}^\circ}$}}
		}{\color{blue}
		\put(-8, 165){\fcolorbox{blue}{white}{$y_\mathrm{stub} = +\mathrm{j} 1.16$}}
		\put(-55, 135){\fcolorbox{blue}{white}{$l = 0.136\;\lambda$}}
		\put(-65, 105){\fcolorbox{blue}{white}{$y_\mathrm{open} = 0$}}
		}{\color{red}
		\put(5, 150){\fcolorbox{red}{white}{$y_\mathrm{S}^* = 0.866 + \mathrm{j} 1.06$}}
		\put(40, 104){\fcolorbox{red}{white}{$d = 0.177\;\lambda$}}
		\put(10, 60){\fcolorbox{red}{white}{$y_\mathrm{S}^* \,\!' = 1 - \mathrm{j} 1.16$}}
		}
	\end{picture}
\end{center}
\end{figure}
